...
| 文档                                                                                   | 说明                                                                        |
| -------------------------------------------------------------------------------------- | --------------------------------------------------------------------------- |
| [PawHaven-System-Architecture.md](./PawHaven-System-Architecture.md)                   | 系统架构设计 v3.4 — 服务拆分、模块化单体、部署拓扑、数据流                  |
| [PawHaven-System-Architecture-Overview.md](./PawHaven-System-Architecture-Overview.md) | 系统架构 v3.4 — 5 个服务、API 网关路由（内部 JWT 认证）、事件目录、数据架构 |
