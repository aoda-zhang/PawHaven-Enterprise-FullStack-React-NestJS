...
| [architecture-change](./architecture-change.md) | Architecture change   | Step 1 design decision with impact analysis → Step 2 update the living architecture docs when needed → Step 3 migrate-callers-then-delete discipline.                  |
