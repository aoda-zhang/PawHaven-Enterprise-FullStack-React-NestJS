...
> **Complexity classification** (per pawhaven.md §3.0): Features are typically **Standard** or **Architectural**. pawhaven classifies before starting this workflow. Standard features follow the steps below. Architectural features add a living-architecture-docs update step and mandatory architect review before implementation begins.
